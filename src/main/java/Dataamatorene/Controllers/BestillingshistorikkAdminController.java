...
public class BestillingshistorikkAdminController {
    ...
    public void initialize() {
        ...
        bLydkort.setCellValueFactory(new PropertyValueFactory<>("lydkortT"));
        tbSkjermkort.setCellValueFactory(new PropertyValueFactory<>("skjermkortT"));
        tbProsessor.setCellValueFactory(new PropertyValueFactory<>("prosessorT"));
        tbMinne.setCellValueFactory(new PropertyValueFactory<>("minneT"));
        tbKabinett.setCellValueFactory(new PropertyValueFactory<>("kabinettT"));
        tbSkjerm.setCellValueFactory(new PropertyValueFactory<>("skjermT"));
        tbTastatur.setCellValueFactory(new PropertyValueFactory<>("tastaturT"));
        tbMus.setCellValueFactory(new PropertyValueFactory<>("musT"));
        tbDato.setCellValueFactory(new PropertyValueFactory<>("datoT"));
        tbOrdrenummer.setCellValueFactory(new PropertyValueFactory<>("bestillingsnummerT"));
        tbPris.setCellValueFactory(new PropertyValueFactory<>("prisT"));
    ...
    void vis(ActionEvent event) {
        if (tvBestillinger.getSelectionModel().getSelectedItem() != null) {
            Dialogs.showInformationDialog("Bestilling", tvBestillinger.getSelectionModel().getSelectedItem().toString());
        }
    }
